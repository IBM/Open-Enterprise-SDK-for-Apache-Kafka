...
//**********************************************************************
//*
//* This JCL is used to run the Producer program - IXYPRO31.
...
//*    librdkakfka.so.1
//*
//* 5) Change @@TOPIC_NAME@@ to the topic name
//*
//* 6) Change @@KAFKA-MSG@@ to the Kafka Message to be produced
//*
//* 7) PARM parameter consists value for disabling the Log conversion
...
//* Run KAFKA IXYPRO31
//********************************************************************
//PRODUCER EXEC PGM=IXYPRO31,REGION=0M,
