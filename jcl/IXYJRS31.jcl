...
//**********************************************************************
//*
//* This JCL is used to run the consumer program - IXYCNS31.
...
//*    librdkakfka.so.1
//*
//* 5) Change @@TOPIC_NAME@@ to the topic name which is of 4 characters
//*    currently. Change the program accordingly to increase the length
//*
...
//* Run KAFKA IXYCNS31
//********************************************************************
//PRODUCER EXEC PGM=IXYCNS31,REGION=0M,
//             PARM='@@TOPIC_NAME@@ENABLE-LOG-CONV'
