...
//**********************************************************************
//*
//* This JCL is used to run the consumer program - IXYCON31.
...
//*    librdkakfka.so.1
//*
//* 5) PARM parameter consists value for disabling the Log conversion
...
//* Run KAFKA IXYCON31
//********************************************************************
//CONSUMER EXEC PGM=IXYCON31,REGION=0M,PARM='ENABLE-LOG-CONV'
...
/*
//CONFFILE DD DSN=&IXYHLQ..SIXYCFG(IXYCCONF),DISP=SHR
