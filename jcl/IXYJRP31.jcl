...
//**********************************************************************
//*
//* This JCL is used to run the Producer program - IXYPRD31.
...
//*    librdkakfka.so.1
//*
//* 5) Change @@EVENTFIL@@ with the event dataset which contains data
//*    to be produced
//*
//* 6) PARM parameter consists value for disabling the Log conversion
//*    from ASCII to EBSIDIC. Use 'DISABLE-LOG-CONV' for disabling and
//*    'ENABLE-LOG-CONV' for conversion to happen.
//*
//********************************************************************
...
//* Run KAFKA IXYPRD31
//********************************************************************
//PRODUCER EXEC PGM=IXYPRD31,REGION=0M,PARM='ENABLE-LOG-CONV'
...
/*
//EVENTFIL DD DSN=@@EVENTFIL@@,DISP=SHR
//CONFFILE DD DSN=&IXYHLQ..SIXYCFG(IXYPCONF),DISP=SHR
