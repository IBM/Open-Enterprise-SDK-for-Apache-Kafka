...
//**********************************************************************
//*
//* This JCL is used to compile and link-edit the sample IXYPRO64
...
//*
//********************************************************************
//* Compile COBOL program - IXYPRO64
//********************************************************************
...
//SYSIN    DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP(IXYPRO64)
//SYSLIN   DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.OBJ(IXYPRO64)
...
//TRLOG    DD SYSOUT=*
//********************************************************************
//* LinkEdit COBOL object - IXYPRO64
//********************************************************************
...
//         DD *
    ...
    INCLUDE OBJECT(IXYPRO64)
    ENTRY CELQSTRT
    NAME IXYPRO64(R)
/*
//SYSLMOD  DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.LOAD
//SYSDEFSD DD DISP=SHR,DSN=&IXYHLQ..SIXYSDEF(IXYPRO64)
