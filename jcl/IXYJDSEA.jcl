...
//**********************************************************************
//*
//* This JCL is used to compile and link-edit the sample IXYSDSEA
//* program in AMODE 64. This will act as a AMODE 31 to 64 bit
//* conversion layer for calling KAFKA modules.
//*
...
//*
//********************************************************************
//* Compile COBOL program - IXYSDSEA
//********************************************************************
...
//SYSIN    DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP(IXYSDSEA)
//SYSLIN   DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.OBJ(IXYSDSEA)
//SYSLIB   DD DISP=SHR,DSN=&IXYHLQ..SIXYCOPY
//         DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP
//SYSOPTF  DD DATA,DLM='/>'
 LP(64),RENT,EXPORTALL
/>
...
//TRLOG    DD SYSOUT=*
//********************************************************************
//* LinkEdit COBOL object - IXYSDSEA
//********************************************************************
// IF (COMPCOB.RUN AND (COMPCOB.RC EQ 0 OR
//   COMPCOB.RC EQ 4)) THEN
//LKEDCOB    EXEC PGM=IEWBLINK,
// PARM='LIST,MAP,AMODE=64,RENT,XREF,DYNAM(DLL),LET,CASE(MIXED)'
//*
...
//SYSLIN   DD DISP=SHR,DSN=&IXYHLQ..SIXYSDEF(IXYSSDEF)
//         DD DISP=SHR,DSN=&IXYHLQ..SIXYSDEF(IXYSFUNC)
//         DD *
    INCLUDE SYSLIB(CELQV004)
    INCLUDE OBJECT(IXYSDSEA)
    ENTRY CELQSTRT
    NAME IXYSDSEA(R)
/*
//SYSLMOD  DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.LOAD
//SYSDEFSD DD DISP=SHR,DSN=&IXYHLQ..SIXYSDEF(IXYSDSEA)
