...
//**********************************************************************
//*
//* This JCL is used to compile and link-edit the sample IXYPAV64
//* program in AMODE 64.
//*
...
//*
//********************************************************************
//* Compile COBOL program - IXYPAV64
//********************************************************************
...
//SYSIN    DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP(IXYPAV64)
//SYSLIN   DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.OBJ(IXYPAV64)
...
//TRLOG    DD SYSOUT=*
//********************************************************************
//* LinkEdit COBOL object - IXYPAV64
//********************************************************************
...
//         DD *
    ...
    INCLUDE OBJECT(IXYPAV64)
    ENTRY CELQSTRT
    NAME IXYPAV64(R)
/*
//SYSLMOD  DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.LOAD
//SYSDEFSD DD DISP=SHR,DSN=&IXYHLQ..SIXYSDEF(IXYPAV64)
