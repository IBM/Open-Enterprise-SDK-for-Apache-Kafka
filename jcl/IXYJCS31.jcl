...
//**********************************************************************
//*
//* This JCL is used to compile and link-edit the sample IXYCNS31
...
//*
//********************************************************************
//* Compile COBOL program - IXYCNS31
//********************************************************************
...
//SYSIN    DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP(IXYCNS31)
//SYSLIN   DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.OBJ(IXYCNS31)
...
//TRLOG    DD SYSOUT=*
//********************************************************************
//* LinkEdit COBOL object - IXYCNS31
//********************************************************************
