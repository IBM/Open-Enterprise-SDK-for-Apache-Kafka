...
//**********************************************************************
//*
//* This JCL is used to compile and link-edit the sample IXYSVER
//* program in AMODE 64. This program will print Kafka version.
//*
...
//*
//* 3) Change TSCTEST.CEEZ310 to the HLQ for Language Environment
//*    libraries. ex: CEE
//*
//* 4) Change TSC390.COBOL.IGY.V6R4M0.GOOD to the HLQ for COBOL compiler
//*    ex: IGY
//*
...
//SYSIN    DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP(IXYSVER)
//SYSLIN   DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.OBJ(IXYSVER)
...
//         DD DISP=SHR,DSN=&IXYHLQ..SIXYSDEF(IXYFUNC)
//         DD *
    INCLUDE SYSLIB(CELQV004)
    INCLUDE OBJECT(IXYSVER)
    ENTRY CELQSTRT
    NAME IXYSVER(R)
/*
//SYSLMOD  DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.LOAD
//SYSDEFSD DD DISP=SHR,DSN=&IXYHLQ..SIXYSDEF(IXYSVER)
