...
//**********************************************************************
//*
//* This JCL is used to compile and link-edit the sample IXYCON31
...
//*
//********************************************************************
//* Compile COBOL program - IXYCON31
//********************************************************************
...
//SYSIN    DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP(IXYCON31)
//SYSLIN   DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.OBJ(IXYCON31)
...
//TRLOG    DD SYSOUT=*
//********************************************************************
//* LinkEdit COBOL object - IXYCON31
//********************************************************************
