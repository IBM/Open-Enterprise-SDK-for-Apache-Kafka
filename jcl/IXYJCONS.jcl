...
//**********************************************************************
//*
//* This JCL is used to compile and link-edit the sample IXYSCONS
...
//*
//********************************************************************
//* Compile COBOL program - IXYSCONS
//********************************************************************
...
//SYSIN    DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP(IXYSCONS)
//SYSLIN   DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.OBJ(IXYSCONS)
...
//TRLOG    DD SYSOUT=*
//********************************************************************
//* LinkEdit COBOL object - IXYSCONS
//********************************************************************
...
//         DD *
    ...
    INCLUDE OBJECT(IXYSCONS)
    ENTRY CELQSTRT
    NAME IXYSCONS(R)
/*
//SYSLMOD  DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.LOAD
//SYSDEFSD DD DISP=SHR,DSN=&IXYHLQ..SIXYSDEF(IXYSCONS)
