...
//**********************************************************************
//*
//* This JCL is used to run the Kafka version program - IXYSVER.
//* The JCL will print the Kafka version in SYSOUT.
//*
...
//*    libraries. ex: CEE
//*
//* 4) Change @@LIBPATH@@ in CEEOPTS(ENVAR) DD to the USS path of
//*    librdkakfka.so.1
//*
//********************************************************************
