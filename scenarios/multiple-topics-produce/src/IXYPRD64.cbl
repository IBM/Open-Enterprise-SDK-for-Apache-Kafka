      ...
      ******************************************************************
       ...
       01 TIMEOUT-MS             PIC S9(9) BINARY
                                             VALUE 5000.
       01 TOPIC.
          02 TOPIC-ARRAY OCCURS 5 TIMES.
             04 TOPIC-NAME       PIC X(2049).
       01 NUM-OF-TOPICS          PIC S9(09) BINARY
                                             VALUE 0000.
      ...
      * Configuration file
       01 WS-CNT                 PIC S9(9) BINARY
                                             VALUE 0000.
       01 WS-EVENT-CNT           PIC S9(9) BINARY
                                             VALUE 0000.
       01 WS-PARMLEN             PIC S9(9) BINARY
                                             VALUE 0000.
       01 WS-VALLEN              PIC S9(9) BINARY
                                             VALUE 0000.
       01 WS-MSGLEN              PIC S9(9) BINARY
                                             VALUE 0000.
      ...
      * Output values for Producer program
       ...
       PROCEDURE DIVISION.
           DISPLAY "KAFKA AMODE 64 PRODUCER MAIN PROGRAM"
           PERFORM READ-PRODUCER-CONFIG
           PERFORM READ-PRODUCER-TOPIC
           MOVE 1 TO WS-CNT

           PERFORM UNTIL WS-CNT > NUM-OF-TOPICS
                   MOVE TOPIC-NAME(WS-CNT) TO KAFKA-TOPIC-NAME
                   MOVE WS-CNT TO KAFKA-TOPIC-NBR
           ...
           PERFORM UNTIL WS-EOF
                   ...
                   NOT AT END
                       ...
                       SET KAFKA-PAYLOAD TO ADDRESS OF WS-MSG-BUF
                       MOVE WS-MSGLEN TO KAFKA-PAYLOAD-LEN
                       MOVE 1 TO WS-CNT
                       PERFORM UNTIL WS-CNT > NUM-OF-TOPICS
                               MOVE TOPIC-NAME(WS-CNT) TO
                                  KAFKA-TOPIC-NAME
                               MOVE WS-CNT TO KAFKA-TOPIC-NBR
           ...
           DISPLAY "NUMBER OF KAFKA MESSAGES PRODUCED : " WS-EVENT-CNT
           MOVE 1 TO WS-CNT
           PERFORM UNTIL WS-CNT > NUM-OF-TOPICS
                   MOVE TOPIC-NAME(WS-CNT) TO KAFKA-TOPIC-NAME
                   MOVE WS-CNT TO KAFKA-TOPIC-NBR
           ...
           PERFORM UNTIL WS-EOF
                   ...
                   NOT AT END
                       ...
                       MOVE FUNCTION TRIM(TOPIC-DATA-REC) TO
                          TOPIC-NAME(WS-CNT)(1:TOPIC-LENGTH)
                       MOVE LOW-VALUE TO TOPIC-NAME(WS-CNT)
                          (TOPIC-LENGTH + 1:)

                   END-READ
           END-PERFORM
           MOVE WS-CNT TO NUM-OF-TOPICS
           DISPLAY "NUMBER OF TOPICS : " NUM-OF-TOPICS
           CLOSE TOPICFIL.
