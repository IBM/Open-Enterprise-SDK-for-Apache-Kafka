      ...
      ******************************************************************
       ...
       PROCEDURE DIVISION USING DESERIAL-AVRO-INPUT
      ...
      * Create SERDES Object
            ...
            IF SERDES-T-REF OF SERDES-NEW-OUT = NULL
               ...
               GOBACK
             ELSE
               MOVE 0 TO SERDES-MSG-RESPONSE OF DESERIAL-AVRO-OUTPUT
      ...
      * De-Serialize Avro
           WHEN SERDES-DESER
             ...
             SET SERDES-T-REF OF SERDES-DSERIALIZE-IN TO
               SERDES-T-REF OF SERDES-NEW-OUT

             SET EBCDIC-DATA-PTR-31 OF EBCDIC-ASCII-CONV-IN
                TO ADDRESS OF SCHEMA-NAME OF DESERIAL-AVRO-INPUT
             ...
             SET SCHEMA-NAME-PTR OF SERDES-DSERIALIZE-IN TO  
                  ADDRESS OF SCHEMA-TEMP

             SET ERRSTR-PTR OF SERDES-DSERIALIZE-IN TO
                            ADDRESS OF ERR-STG

             IF CALLER-31BIT = 'Y'
               SET PAYLOAD-PTR OF SERDES-DSERIALIZE-IN TO
                         SER-PAYLOAD-31 OF DESERIAL-AVRO-INPUT
             ELSE
               SET PAYLOAD-PTR OF SERDES-DSERIALIZE-IN TO
                         SER-PAYLOAD-64 OF DESERIAL-AVRO-INPUT
             END-IF

             MOVE SER-MESSAGE-LEN OF DESERIAL-AVRO-INPUT TO
                   PAYLOAD-SIZE OF SERDES-DSERIALIZE-IN

             MOVE FUNCTION IXY-SERDES-DSERIALIZE(
                        SERDES-T-REF OF SERDES-DSERIALIZE-IN
                        SCHEMA-NAME-PTR OF SERDES-DSERIALIZE-IN
                        PAYLOAD-PTR OF SERDES-DSERIALIZE-IN
                        PAYLOAD-SIZE OF SERDES-DSERIALIZE-IN
                        DDSER-PTR OF SERDES-DSERIALIZE-IN
                        ERRSTR-PTR OF SERDES-DSERIALIZE-IN
                        ) TO
                       RETURN-STATUS OF SERDES-DSERIALIZE-OUT


             IF RETURN-STATUS OF SERDES-DSERIALIZE-OUT
               NOT = 0
               DISPLAY "ERROR WHILE DSERIALIZE"
               MOVE ERR-STG TO SERDES-MSG
               MOVE RETURN-STATUS OF SERDES-DSERIALIZE-OUT TO
                    SERDES-MSG-RESPONSE OF DESERIAL-AVRO-OUTPUT
               GOBACK
             ELSE
               IF CALLER-31BIT = 'Y'

                 SET KAFKA-PTR TO DDSER-PTR OF SERDES-DSERIALIZE-IN
                 ...
                 SET DSER-PAYLOAD-31 OF DESERIAL-AVRO-OUTPUT
                     TO KAFKA-PAYLOAD-31 OF CONV-OUTPUT

               ELSE
                 SET  DSER-PAYLOAD-64 OF DESERIAL-AVRO-OUTPUT TO
                      DDSER-PTR OF SERDES-DSERIALIZE-IN
               END-IF

               MOVE 0 TO SERDES-MSG-RESPONSE
               MOVE "SERDES DESERIALIZATION DONE" TO SERDES-MSG
             END-IF
      ...
      * Clean-up
           ...
           WHEN OTHER
             ...
             MOVE "INVALID SERDES-ACTION FOR DESERIALIZATION"
               TO SERDES-MSG
