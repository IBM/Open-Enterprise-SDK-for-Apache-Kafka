      ...
      ******************************************************************
         ...
         01 WS-TIMEOUT-MS       PIC S9(9)  BINARY VALUE 8000.
         ...
         01 INDEX-POS           PIC 9(9) BINARY VALUE 0.
         01 KAFKA-MSG-ASCII-PTR PIC 9(9) USAGE COMP-5.
         01 KAFKA-MSG-ASCII-PTR-31  REDEFINES
                                  KAFKA-MSG-ASCII-PTR USAGE POINTER-32.
      ...
      * KAFKA-TYPE-PC is 1 for CONSUMER
           ...
           MOVE WS-TIMEOUT-MS   TO TIMEOUT-MS-VALUE
