      ...
      *    generated code IXYPRJSN and IXYCP2JS.
      ...
      *    accordingly. i.e., IXYPRJSN, IXYCASC, IXYJS2CP and IXYVARSN
      ...
      ******************************************************************
         ...
         01 CC2J-PGM            PIC X(8) VALUE "IXYCP2JS".

       PROCEDURE DIVISION.

           DISPLAY "DTUS AMODE 64 PRODUCER PROGRAM"
      ...
      * for setting up the SERDES connection. Configuration file is
      * read and parsed to extract the configuration Parameter and its
      * value. Length of Configuration Parameter and its value is
      * determined. End of string (LOW VALUES) is appended to the
      * configuration parameter and value. This file can contain
      * comments starting with '#'. Parameter and Value is delimited
      ...
      *****************************************************************
           ...
           CALL CC2J-PGM USING EVENT-DATA
                         RETURNING JSON-DATA
      ...
      *****************************************************************
           ...
           SET JSON-PAYLOAD-64 OF  SERIAL-AVRO-INPUT TO
      ...
      *****************************************************************
      * The Events details are provided in the program and Producer
      * Program is invoked for the event to Produce the Kafka event
      *****************************************************************

           MOVE 'P'        TO KAFKA-ACTION OF PRODUCER-INPUT
           SET KAFKA-PAYLOAD OF PRODUCER-INPUT TO
             SER-PAYLOAD-64 OF SERIAL-AVRO-OUTPUT
