      ...
      *    transformation utility generated code IXYCNJSN.
      ...
      *     accordingly. i.e., IXYCNJSN, IXYCASC and IXYVARSN
      ******************************************************************
      ...
      * Input/Output values for Serialization program
       ...
       PROCEDURE DIVISION.
           DISPLAY "KAFKA AMODE 31 CONSUMER PROGRAM"
      ...
      *****************************************************************
           ...
           MOVE 'Y'  TO CALLER-31BIT OF CONSUMER-INPUT
      ...
      *****************************************************************
           ...
           MOVE 'Y'          TO CALLER-31BIT OF DESERIAL-AVRO-INPUT
           ...
           SET SER-PAYLOAD-31 OF DESERIAL-AVRO-INPUT TO
             KAFKA-PAYLOAD-31 OF CONSUMER-OUTPUT
           ...
           ELSE
             SET ADDRESS OF JSON-MSG-ASCII  TO
               DSER-PAYLOAD-31 OF DESERIAL-AVRO-OUTPUT
