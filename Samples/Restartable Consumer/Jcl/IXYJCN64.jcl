...
//**********************************************************************
//*
//* This JCL is used to compile and link-edit the sample IXYCON64
...
//*
//********************************************************************
//* Compile COBOL program - IXYCON64
//********************************************************************
...
//SYSIN    DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP(IXYCON64)
//SYSLIN   DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.OBJ(IXYCON64)
...
//TRLOG    DD SYSOUT=*
//********************************************************************
//* LinkEdit COBOL object - IXYCON64
//********************************************************************
...
//         DD *
    ...
    INCLUDE OBJECT(IXYCON64)
    ENTRY CELQSTRT
    NAME IXYCON64(R)
/*
//SYSLMOD  DD DISP=SHR,DSN=&IXYHLQ..SIXYSAMP.LOAD
//SYSDEFSD DD DISP=SHR,DSN=&IXYHLQ..SIXYSDEF(IXYCON64)
