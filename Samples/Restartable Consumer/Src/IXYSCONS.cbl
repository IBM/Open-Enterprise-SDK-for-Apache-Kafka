      ...
      * KAFKA-TYPE is 1 for CONSUMER
             ...
             IF RESTART-IND = 'Y'
               ...
               PERFORM UNTIL WS-RCNT > RESTART-PARTNOS
                 ...
                 END-IF
                 ADD 1 TO WS-RCNT
                 DISPLAY "After CONSUME Start "
               END-PERFORM
             ELSE
               DISPLAY "WITHIN NORMAL"
      * Create Partition list
               ...
               IF KAFKA-TOPIC-PART-LIST-REF OF
                 ...
                 MOVE "IXY-KAFKA-TOPIC-PARTLIST-NEW FAILED" TO KAFKA-MSG
      ...
      * Add topic to partition list
               ...
               SET KAFKA-TOPIC-PART-REF OF KAFKA-TOPIC-PART-LIST-ADD-OUT
                   TO
               ...
               IF KAFKA-TOPIC-PART-REF OF
                 ...
                 MOVE "IXY-KAFKA-TOPIC-PARTLIST-ADD FAILED" TO KAFKA-MSG
      ...
      * Process KAFKA Message
                 ...
                 IF KAFKA-MESSAGE-REF OF KAFKA-CONSUME-OUT
                   ...
                   DISPLAY "TOPIC : " MSG-TOPIC
                   DISPLAY "MSG-PARTITION : " MSG-PARTITION
                   DISPLAY "PAYLOAD : " MSG-PAYLOAD
                   DISPLAY "MSG-LENGTH : " MSG-LENGTH
                   DISPLAY "MSG-OFFSET : " MSG-OFFSET
                 ...
                 ELSE IF KAFKA-MESSAGE-REF OF KAFKA-CONSUME-OUT
                   ...
                   DISPLAY "INSIDE LAST ERROR PART"
      ...
      *              END-IF
                     ...
                     IF WS-RCNT < RESTART-PARTNOS
                       ...
                       ADD 1 TO WS-RCNT
                       DISPLAY "PARTITION EMPTY FROM LAST ERROR"
                     ELSE
                       MOVE 'N' TO RESTART-FLAG(WS-RCNT)
                       ADD 1 TO WS-RCNT
                       MOVE RETURN-STATUS  OF KAFKA-LAST-ERROR-OUT TO
      ...
      * Free KAFKA Message
                   ...
                   DISPLAY "Before Message Destroy"
      ...
      * Process KAFKA Message
               ...
               ELSE IF KAFKA-MESSAGE-REF OF KAFKA-CONSUMER-POLL-OUT
                             = NULL AND ERROR-CODE = 0
                 ...
                 DISPLAY "Last error code : "
                   RETURN-STATUS OF KAFKA-LAST-ERROR-OUT
      ...
      *        DISPLAY "EVENT-CNT FROM POLL : " EVENT-CNT
             ...
             ELSE
               ...
               IF RETURN-STATUS OF KAFKA-TOPIC-PARTLIST-DEST-OUT
                                                 NOT = 0
                 MOVE 'ERROR DURING TOPIC PARLIST DESTROY' TO KAFKA-MSG
      ...
      * Close Kafka
               ...
               IF RETURN-STATUS  OF KAFKA-CONSUMER-CLOSE-OUT NOT = 0
                 DISPLAY " **ERROR** : IXY-KAFKA-CONSUMER-CLOSE FAILED"
